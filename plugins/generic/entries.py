        ...
        for tbl in tblList:
            ...
            try:
                    ...
                    if not isNoneValue(entries):
                        ...
                        for index, column in enumerate(colList):
                            ...
                            for entry in entries:
                                ...
                                maxLen = max(len(column),
                                             len(DUMP_REPLACEMENTS.get(getUnicode(colEntry), getUnicode(colEntry))))
                ...
                if not kb.data.dumpedTable and isInferenceAvailable() and not conf.direct:
                    ...
                    DBMS.ACCESS, DBMS.SYBASE, DBMS.MAXDB, DBMS.MSSQL, DBMS.INFORMIX):
                            ...
                            try:
                                ...
                                for index in indexRange:
                                    for column in colList:
                                        ...
                                        lengths[column] = max(lengths[column], len(
                                            DUMP_REPLACEMENTS.get(getUnicode(value), getUnicode(value))))
